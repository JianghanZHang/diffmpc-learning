...
each AD (jax.grad through the rollout) vs convergence-checked FD of its own rollout.
    ...
    python experiments/cartpole/closed_loop_cartpole.py --smoke
    python experiments/cartpole/closed_loop_cartpole.py [--slack] --n_samples 6
"""
...
for _p in (os.path.join(_DL_ROOT, "src"), os.path.join(_DL_ROOT, "external", "diffmpc2"), _HERE):
